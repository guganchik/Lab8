    ...
    public LoginFrame() {
        ...
        loginButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Application.getInstance().userLogin(loginField.getText(), passwordField.getText());
            }
        });
        c.gridx = 0;
        c.gridy = 0;
        ...
        label = new JLabel("Don't have account?");
        label.setFont(font);
        c.gridx = 0;
        c.gridy = 1;
        c.insets = new Insets(40,00,0,0);
        pane.add(label, c);
        ...
        registerButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Application.getInstance().userHaveNoLogin();
            }
        });
        c.gridx = 0;
        c.gridy = 2;
